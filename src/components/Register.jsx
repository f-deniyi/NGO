    ...
    <div className="block md:flex">
      ...
      <div className=" h-screen w-full bg-slate-100  ">
        <div className="mx-auto flex justify-center h-screen items-center w-4/5 md:w-3/5 flex-col">
          ...
          <form className="w-full  bg-white rounded-md flex flex-col py-3  pb-8 items-center shadow-md">
            <h1 className="text-3xl font-bold pt-8 pb-5">JOIN US</h1>
            <input
              className="text-sm p-3 mb-4 rounded-md mx-auto w-4/5 bg-slate-100"
              placeholder="Email"
              type="email"
            />
            <input
            ...
            <h2 className="mb-3 social-login">Sigup in with</h2>
