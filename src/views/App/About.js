  ...
  return (
    ...
    <div className="text-gray-800 bg-white">
      ...
      <div className='px-5 md:px-10 bg-white py-3 md:py-5 pb-4 md:pb-7'>
        <p className="my-0 md:my-3 tracking-wide">The
        ...
        <div className="flex flex-wrap mb-7">
          <div className="grow-0 shrink-0 basis-auto w-full lg:w-6/12 lg:pr-6 mb-6 lg:mb-0">
            <div className="relative overflow-hidden bg-no-repeat bg-cover ripple  zoom hadow-lg rounded-lg"
              ...
              <img src={mission} className="w-full  h-[300px] " alt="Louvre" />
        ...
        <div className="flex flex-wrap lg:flex-row-reverse ">
          <div className="grow-0 shrink-0 basis-auto w-full lg:w-6/12 lg:pl-6 mb-6 lg:mb-0">
            <div className="relative overflow-hidden bg-no-repeat bg-cover ripple zoom shadow-lg rounded-lg "
              style={{ backgroundPosition: "50%" }} data-mdb-ripple="true" data-mdb-ripple-color="light">
              <img src={guide} className="w-full h-[300px] " alt="Louvre" />

            </div>
          </div>

          <div className="grow-0 shrink-0 basis-auto w-full lg:w-6/12 lg:pr-6">
            <h3 className="text-2xl font-bold mb-3">Our Guiding Principles</h3>
            <ul className='mb-2'>
      ...
      <section className="text-gray-800 px-5 md:px-10 py-7">
        <div className="flex justify-center">
          <div className="">
            <h2 className="text-3xl font-bold mb-2 text-center">Overview</h2>
            <p className="mb-2">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-6 xl:gap-x-12">
          <div className="mb-3">
            <div className="flex">
              ...
              <div className="grow ml-4">
                <p className="font-bold mb-1">Diabetes and its impact on women</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-3">
            <div className="flex">
              ...
              <div className="grow ml-4">
                <p className="font-bold mb-1">Cervical cancer and HPV vaccine</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-3">
            <div className="flex">
              ...
              <div className="grow ml-4">
                <p className="font-bold mb-1">HIV/AIDS and access to treatment for women</p>
          ...
          <div className="mb-3">
            <div className="flex">
              ...
              <div className="grow ml-4">
                <p className="font-bold mb-1">Coronary heart disease</p>
              </div>
            </div>
          </div>
          ...
          <div className="">
            <div className="flex">
              ...
              <div className="grow ml-4">
                <p className="font-bold mb-2 md:mb-1">Depression</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-3">
            <div className="flex">
              ...
              <div className="grow ml-4">
                <p className="font-bold mb-1">Osteoporosis and osteoarthritis</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-3">
            <div className="flex">
              ...
              <div className="grow ml-4">
                <p className="font-bold mb-1">Smoking and women's health</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-3">
            <div className="flex">
              ...
              <div className="grow ml-4">
                <p className="font-bold mb-1">Trachoma</p>
              </div>
            </div>
          </div>
        </div>
